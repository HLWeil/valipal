...
let createTag = BuildTask.create "CreateTag" [clean; buildSolution; runTests] {
...
let publishNuget = BuildTask.create "PublishNuget" [clean; buildSolution; runTests; packDotNet] {
...
let publishNPM = BuildTask.create "PublishNPM" [clean; buildSolution; runTests; packJS] {
    let target = 
...
let publishPyPi = BuildTask.create "PublishPyPi" [clean; buildSolution; runTests; packPy] {
